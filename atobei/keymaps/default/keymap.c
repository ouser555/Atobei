...
enum custom_keycodes {
  ...
  DRAG_SCROLL_M,
  DRAG_SCROLL_S,
  HOLD_ON_OKPPK,  //HOLD_ON_OTHER_KEY_PRESS_PER_KEY
  V99_SAFE_RANGE,
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QW] = LAYOUT( /* Qwerty */
    ...
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_A,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH ,
  ...
  [_QWERTY] = LAYOUT( /* Qwerty */
    ...
    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN ,
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_A,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH ,
    KC_ESC, KC_TAB, KC_LGUI,  KC_LSFT, KC_BSPC,  KC_LCTL, KC_LALT, KC_SPC,  MO(_RAISE),    KC_N,    KC_QUOT, KC_ENT
  ),
#endif
  ...
  [_LOWER] = LAYOUT( /* [> RAISE <] */
    ...
    KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_AMPR, KC_A,    KC_B,    KC_GRV,  KC_1,    KC_2,   KC_3, KC_BSLS ,
    TG(_RAISE), KC_INS,  KC_LGUI, KC_LSFT, KC_BSPC, KC_LCTL, KC_LALT, KC_SPC,  KC_TRNS, KC_DOT, KC_0, KC_EQL  ),
  /*
  ...
  [_RAISE] = LAYOUT( /* [> LOWER <] */
    ...
    KC_NO,   KC_VOLU, KC_NO,   KC_NO,   RESET,   KC_A,    KC_B,    KC_NO,   KC_F1,   KC_F2,   KC_F3,   KC_F12  ,
    KC_NO,   KC_VOLD, KC_LGUI, KC_LSFT, KC_BSPC, KC_LCTL, KC_LALT, KC_SPC,  TO(_LOWER), KC_PSCR, KC_SLCK, KC_PAUS ),
  /*
   * insert home   up  end   pgup       ||      up     F7    F8    F9   F10
   *  del   left  down right pgdn       ||     down    F4    F5    F6   F11
   *       volup             reset      ||             F1    F2    F3   F12
